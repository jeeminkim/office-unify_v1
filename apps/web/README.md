...
- **종목 탐색** (`/discover`): 종목명·코드·티커 검색, 토스 현재가와 5일/20일 가격 흐름, 투자 유의사항을 결합한 개인화 관심 후보 및 관심종목 바로 추가.
...
- `GET /api/portfolio/summary`
  - 개인 콘솔형 포트폴리오 요약 계약
  - quote provider 우선순위: Toss Securities Open API -> Google Sheets `GOOGLEFINANCE` read-back -> Yahoo fallback -> none
